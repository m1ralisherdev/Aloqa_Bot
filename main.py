...
#     await message.answer('Administrator bilan bog\'lanish uchun shu yerga yozing: @nadia_admini')
#     await message.answer('Administrator bilan bog\'lanish uchun telefon raqam: +998 95 049 33 33')
#
# # `Callback` yordamida inline tugmalarni boshqarish
...
#     await query.message.answer(f'"{course}" haqida malumot: {course_info.get(course, "Malumot topilmadi.")}')
#     await query.answer()
#
# # Botni boshlash
